...
bool Game::Initialize()
{
	...
	// TODO: When you're finished with part 1-3, uncomment this
			...
			if (p->GetType() != PathNode::Tunnel)
			{
				for (auto n : p->mAdjacent)
				{
					SDL_RenderDrawLine(mRenderer,
						static_cast<int>(p->GetPosition().x),
...
{
	Mix_PlayChannel(-1, GetSound("Assets/Sounds/IntroMusic.wav"), 0);
...
void Game::DoGameWin()
{
	Mix_PlayChannel(-1, GetSound("Assets/Sounds/WinMusic.wav"), 0);
